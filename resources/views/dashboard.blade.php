    ...
    <nav class="navbar navbar-light bg-light p-3">
        ...
        <div class="d-flex col-12 col-md-3 col-lg-2 mb-2 mb-lg-0 flex-wrap flex-md-nowrap justify-content-between">
            <a class="navbar-brand p-0" href="#">
                <!-- <img class="p-0" src="THINKONE SYSTEM SUPPORT.png" alt="icon" width="130" height="40"> -->
                Sample
            </a>
            ...
            <main class=" ms-sm-auto col-lg-10">
                <div class="row">
                            ...
                            <ul class="list-group list-group-flush nav">
                                ...
                                @foreach ($incidents as $incident)
                                    <li class="list-group-item">
                                        <div class="row">
                                            <div class="col">{{ $incident->title }}</div>
                    ...
                    <div class="col-lg-7 p-0 third_bar">
                        ...
                        @foreach ($incidents[0]->threads as $thread)
                            <div class="card third_bar_card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">{{ $thread->title }}
                                    </h5>
                                    <p class="card-text">
                                        {{ $thread->body }}
                                    </p>
